...
if( !function_exists('wpestate_ajax_check_booking_valability') ):
    function wpestate_ajax_check_booking_valability(){
        ...
        $wpestate_book_from  =   ($_POST['book_from']);
        $wpestate_book_to    =   esc_html($_POST['book_to']);  
        $listing_id =   intval($_POST['listing_id']);
        $internal   =   intval($_POST['internal']);
        $mega       =   wpml_mega_details_adjust($listing_id);;
                ...
                print '
                   <div class="invoice_table">';
                       ...
                       <div class="invoice_data">
                        ...
                        print ' 
                            <div class="invoice_row invoice_total total_inv_span total_invoice_for_payment">
                               ...
                               <span class="inv_legend">'.esc_html__( 'Reservation Fee Required','wprentals').':</span> <span class="inv_depozit depozit_show" data-value="'.esc_attr($depozit).'"> '.$depozit_show.'</span></br>
                               <span class="inv_legend">'.esc_html__( 'Balance owed','wprentals').':</span> <span class="inv_depozit balance_show"  data-value="'.esc_attr($balance).'">'.$balance_show.'</span>
                           </div>
                       </div>';
                    ...
                    if($wpestate_global_payments->is_woo=='yes'){
                        ...
                        $wpestate_global_payments->show_button_pay($property_id,$bookid,$invoice_id,$depozit,1);
                    ...
                    <div class="invoice_details">
                        ...
                        <div class="invoice_row invoice_content">
                            ...
                            <div class="invoice_row invoice_total invoice_total_generate_invoice">
                                ...
                                <span class="total_inv_span"><span class="inv_legend"> '.esc_html__( 'Reservation Fee Required','wprentals').':</span> <span id="inv_depozit" data-value="'.esc_attr($depozit).'">'.$deposit_show.'</span>
                                <div style="width:100%"></div>
                                <span class="inv_legend">'.esc_html__( 'Balance Owed','wprentals').':</span> <span id="inv_balance" data-val="'.esc_attr($balance).'">'.$balance_show.'</span>
                            </div>';
                            ...
                            <div class="invoice_row invoice_totalx invoice_total_generate_invoice">
                                ...
                                <span class="total_inv_span">
                                    ...
                                    <span id="inv_service_fee" data-value="'.esc_attr($booking_array ['service_fee']).'"  data-value-fixed-hidden="'.  floatval ( wprentals_get_option('wp_estate_service_fee_fixed_fee','') ).'">'.$service_fee_show.'</span>
                                    
                                    <div style="width:100%"></div>
                                    
                                    <span class="inv_legend">'.esc_html__( 'Taxes','wprentals').':</span>
                                    <span id="inv_taxes" data-value="'.esc_attr($booking_array ['taxes']).'" >'.$taxes_show.'</span>
                                </span>    
