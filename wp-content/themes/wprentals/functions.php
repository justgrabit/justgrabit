...
function wpestate_admin_notice() {
    ...
    if( !is_array($wpestate_notices) || 
        !isset($wpestate_notices['wp_estate_update_25']) ||
        ( isset($wpestate_notices['wp_estate_update_25']) && $wpestate_notices['wp_estate_update_25']!='yes')  ){
        
        print '<div  id ="setting-error-wprentals-cache"  data-notice-type="wp_estate_update_25"  data-dismissible="disable-done-notice-forever" class="wpestate_notices updated settings-error notice is-dismissible">
            <p>'.esc_html__( 'Attention! For WpRentals v2.5 or later Child Theme wprentals-child/functions.php must be updated as detailed in this ','wprentals').'<a href="https://help.wprentals.org/article/wp-rentals-2-50/" target="_blank">'.esc_html__('help article','wprentals').'</a></p>
        </div>';
    }
