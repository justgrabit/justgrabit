...
if (!function_exists('wpestate_modify_contact_methods')):
    ...
    function wpestate_modify_contact_methods($profile_fields) {
        ...
        $profile_fields['check_phone_valid']            = esc_html__('Mobile Verfied','wprentals-core');
        ...
        $profile_fields['paypal_agreement']             = esc_html__('Paypal Recuring Profile- rest api','wprentals-core');
        $profile_fields['profile_id']                   = esc_html__('Paypal Recuring Profile','wprentals-core');
