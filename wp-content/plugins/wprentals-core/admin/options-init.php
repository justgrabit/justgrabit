    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'subtitle' => __( 'Use GDPR Checkbox ?', 'wpresidence-core' ),
                'options'  => array(
                             'no'  => 'no',
                             'yes' => 'yes'
                            ),
        ...
        'fields'     => array(
           array(
            ...
            array(
                ...
                'desc'     => esc_html__('%user_login_register as new username, %user_pass_register as user password, %user_email_register as new user email, use text mode and <br> tag for new line', 'wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'desc'     =>esc_html__( '%user_login_register as new username and %user_email_register as new user email, use text mode and <br> tag for new line', 'wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__(' use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'default'  => __('Someone requested that the password be reset for the following account:
                                ...
                                Thank You!', 'wprentals-core'),
                'desc'     => esc_html__('%reset_link as reset link, %forgot_username as username and %forgot_email as user email, use text mode and <br> tag for new line','wprentals-core' ),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__('* you can use %listing_author% as owner name, %post_id as listing id, %property_url as property url and %property_title as property name, use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__('* you can use %submission_title as property title number, %submission_url as property submission url, use text mode and <br> tag for new line','wprentals-core' ),
            ),
            array(
            ...
            array(
                ...
                'default'  => __('Hi there,
                                ...
                                Thank you!', 'wprentals-core'),
                'desc'     => esc_html__('* you can use %expired_listing_url as expired listing url and %expired_listing_name as expired listing name, use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__('* you can use %new_listing_title as new listing title and %new_listing_url as new listing url, use text mode and <br> tag for new line','wprentals-core' ),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__('* you can use %recurring_pack_name as recurring packacge name and %merchant as merchant name, use text mode and <br> tag for new line','wprentals-core' ),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__('%user_login as username, %user_email_profile as user email, %user_id as user_id, use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__('* you can use %content as message content, use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'desc'     => esc_html__('* you can use %booking_property_link as property url, use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
                'id'       => 'wp_estate_subject_mynewbook',
                'type'     => 'text',
                'title'    => __( 'Subject for User - New Booking Request', 'wprentals-core'),
                'subtitle' => __( 'Email subject for User - New Booking Request', 'wprentals-core' ),
                'default'  => __('You booked a period on %website_url.', 'wprentals-core')
            ),
            array(
                'id'       => 'wp_estate_mynewbook',
                'type'     => 'editor',
                'title'    => __( 'Content for User - New Booking Request', 'wprentals-core' ),
            ...
            array(
                ...
                'desc'     => esc_html__('* you can use %invoice_no as invoice number, %total_price as $totalprice and %payment_details as $payment_details, use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'default'  => __('Hi there,
                                ...
                                Thank you.','wprentals-core'),
                'desc'     => esc_html__('* you can use %invoice_id as invoice id, %property_url as property url and %property_title as property name, %booking_id as booking id, %until_date as the last day, use text mode and <br> tag for new line','wprentals-core'),
            ),
            array(
            ...
            array(
                ...
                'default'  => __('A user added his User ID verification image on %website_url.
                                Username: %user_login.
                                ','wprentals-core'),
                'desc'     => esc_html__('you can use %user_login as username, use text mode and <br> tag for new line','wprentals-core'),
            ),
        ),
    ) );
    ...
    Redux::setSection( $opt_name, array(
      ...
      Redux::setSection( $opt_name, array(
        ...
        array(
               ...
               'type'     => 'info',
                'desc'   =>  __( 'You need WooCommerce Plugin Installed and Active & and a WooCommerce Merchant Enabled. <a href="https://help.wprentals.org/article/install-woocommerce-and-activate-woocommerce-payments/" target="_blank">See help page.</a> </br>Payments are considerd complete once the Order for a particular items has the status "Processing or Complete " . </br> WooComerce does not suport recurring payments, and so submission membership packages cannot be bought via WooCommerce.', 'wprentals-core' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
               ...
               'title'    => __( 'Type 3 and Type 4 custom search fields setup', 'wprentals-core' ),
