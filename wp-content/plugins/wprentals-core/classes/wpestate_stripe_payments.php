            ...
            print'
                <div class="cell wpestate_stripe wpestate_stripe_form_1" >
                    ...
                    <div id="wpestate-stripe-paymentform-1">
                        <fieldset>
                            <div class="row">
                                <label for="wpestate_form_name" data-tid="elements_examples.form.name_label">'.esc_html('Name','wprentals-core').'</label>
                                <input id="wpestate_form_name"  data-tid="elements_examples.form.name_placeholder" type="text" placeholder="'.esc_html('Jane Doe','wprentals-core').'" required="" autocomplete="name">
                            </div>

                            <div class="row">
                                <label for="wpestate_form_email" data-tid="elements_examples.form.email_label">'.esc_html('Email','wprentals-core').'</label>
                                <input id="wpestate_form_email"  data-tid="elements_examples.form.email_placeholder" type="email" placeholder="'.esc_html('janedoe@gmail.com','wprentals-core').'" required="" autocomplete="email">
                            </div>

                            <div class="row">
                                <label for="example1-phone" data-tid="elements_examples.form.phone_label">'.esc_html('Phone','wprentals-core').'</label>
                                <input id="example1-phone" data-tid="elements_examples.form.phone_placeholder" type="tel" placeholder="'.esc_html('999 999-999','wprentals-core').'" required="" autocomplete="tel">
                            </div>
                        </fieldset>
                        ...
                        <button type="submit" id="wpestate_stripe_form_button_sumit" data-tid="elements_examples.form.pay_button" data-secret="'.$this->payment_intent_secret.'">'.esc_html('Pay','wprentals-core').' '.$ammount.' '.$this->currency.'</button>


                        <div class="error" role="alert">
                            <span id="wpestate_stripe_alert" class="message">'.esc_html('Please wait while we confirm your payment!','wprentals-core').'</span>
                        </div>
                    </div>
